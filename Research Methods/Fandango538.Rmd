...
setwd("C:/Users/Neil/Desktop/Class folder/Fall 2017/RM/Analyses/MyClassActivities")
library(tidyverse)
...
plot1 <- filter(fandango_long_grp, website == "Fandango") #" == Fandago" is telling us to only look at Fandango
