...
select(cigarettes = "alc_gm", `peer smokers` = "alcexp", SES = "typ_drks")

#Do the # of peers that smoke predict the number of cigarettes smoked by the individual? 
model <- lm(data = obs, cigarettes ~ `peer smokers` + SES)
summary(model)
